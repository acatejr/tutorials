...
var app = (function () {
    ...
    // (17:1) {#each people as person (person.id)}
    function create_each_block(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			t8 = space();
    			add_location(h4, file, 18, 3, 407);
    			add_location(p, file, 19, 3, 433);
    			add_location(button, file, 20, 3, 493);
    			add_location(div, file, 17, 2, 398);
    			this.first = div;
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(17:1) {#each people as person (person.id)}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(main, "class", "svelte-rzz0c8");
    			add_location(main, file, 15, 0, 351);
    		},
